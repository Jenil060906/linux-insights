...
interface DashboardLayoutProps {
  ...
  host?: HostInfo;
  /** Forwarded to Header — renders its Logout button when provided. */
  onLogout?: () => void;
}

// Shell that every dashboard page renders inside: header + scrollable content area.
export function DashboardLayout({ children, host, onLogout }: DashboardLayoutProps) {
  return (
    <div className="min-h-screen bg-background">
      <Header host={host} onLogout={onLogout} />
